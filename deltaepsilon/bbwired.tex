...
\begin{tikzpicture}[x=5mm,y=5mm]
  ...
  \draw (11,8) to[resistor] (15,8);%lidsensor resistor
  \draw (11,27) to[resistor] (14,24);
  \draw (11,26) to[resistor] (14,23);
  ...
  % hyt1
  \draw[line,yellow] (1,29) to [out=-25,in=180] (25,27);
  \draw[line,green] (1,28) to [out=-35,in=180] (25,25);
  ...
  % hyt2
  \draw[line,yellow] (10,27) to [out=0,in=180] (25,21);
  \draw[line,green] (10,26) to [out=0,in=180] (25,19);
  ...
  %Lid Sensor
  \draw[line,black] (9,8) to [out=40,in=180] (25.4,5.5);
  \draw[line,black] (28.8,7) to  (30,4);
  \filldraw[color=red!60!yellow](28.8,6) circle (.2);
  \filldraw[color=black](30.5,4) circle (.5);
  \draw[line,red] (14,1) to [out=40,in=180] (25.4,6.3);
  \draw[fill=black!60!orange] (25,7) rectangle (28.8,4);
  \node[white,font=\sffamily,scale=0.9] at (27.2,5.5) {Lid Sensor};
  \foreach \m/\yi in {1/6.3,2/5.5,3/4.7}{ \node[white,font=\sffamily,scale=0.8] at (25.4,\yi) {\m};
  }
