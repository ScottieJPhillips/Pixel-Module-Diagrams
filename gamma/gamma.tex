...
\begin{document}
    ...
    \node[hardware] at (7,5) (hvps) {CAEN\\\texttt {}HVPS\\\texttt {}\\\texttt {}Ch4{ { }}Ch5{ { }}Ch6{ { }}Ch7\\\texttt{}$\gamma$ 1{ { }} $\gamma$ 2{ { }} $\gamma$ 3{ { }} $\gamma$ 4 };
    ...
    edge[<-,red,line width=1.5,out=180,in=250] (psc)
    edge[<-,red,line width=1.5,out=130,in=300] (pse)
    edge[->,out=80,in=210] (hvps);
    \node[hardware, right of = int1] (pac1) {Power\\Adapter\\Card}
    edge[<-,red,strike thru arrow, line width=0.75,out=110,in=220] (hvps)
    ...
    edge[<-,dashed,out=0,in=270] (daq);
    
    % gamma2
    \node[hardware] at (4,-3.5) (int2) {Hardware\\Interlock}
    edge[<-,red,line width=1.5,out=180,in=290] (psc)
    edge[<-,red,line width=1.5,out=130,in=293] (pse)
    edge[->,out=80,in=210] (hvps); 
    \node[hardware, right of = int2] (pac2) {Power\\Adapter\\Card}
    edge[<-,red,strike thru arrow,line width=0.75,out=120,in=250] (hvps)
    ...
    edge[<-,red,line width=1.5,out=180,in=250] (psf)
    edge[<-,red,line width=1.5,out=130,in=287] (pse)
    edge[->,out=80,in=210] (hvps); 
    \node[hardware, right of = int3] (pac3) {Power\\Adapter\\Card}
    edge[<-,red,strike thru arrow,line width=0.75,out=80,in=290] (hvps)
    ...
    edge[<-,red,line width=1.5,out=180,in=290] (psf)
    edge[<-,red,line width=1.5,out=130,in=280] (pse)
    edge[->,out=80,in=210] (hvps); 
    \node[hardware, right of = int4] (pac4) {Power\\Adapter\\Card}
    edge[<-,red,strike thru arrow,line width=0.75,out=80,in=315] (hvps)
